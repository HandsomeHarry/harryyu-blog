      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">The ADHD Journey</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">How I Channel ADHD at Work</h2>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Software Engineer Intern - REON Technology Inc.</h3>
              <p className="text-sm text-gray-600 mb-3">June 2023 - Present | Chelmsford, MA</p>
              ...
              <ul className="text-gray-700 space-y-1 mb-4 text-sm">
                <li>• Built Battery Management Systems (got lost in Docker docs for 6 hours, emerged victorious)</li>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Channel Operator & Translator - Bilibili</h3>
              <p className="text-sm text-gray-600 mb-3">November 2020 - Present | Online</p>
              <p className="text-gray-700 mb-2">
                What started as "I'll just translate this one video" became managing 7 people and 164 videos with 180M views. 
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Skills I've Hyperfocused On</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Code & Logic</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-3">Currently Juggling</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>🎓 <del>Finishing CS degree</del> (finally done with school! freedom?)</li>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Why I Blog (when i remember to)</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Current Chaos (aka "Active Projects")</h2>
        <p className="text-gray-700 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-400">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">🤖 AI Chat Platform</h3>
            <p className="text-gray-700 mb-2">
            ...
            <p className="text-sm text-gray-600 mb-2">RTX 3090Ti humming in my room | LLM, Docker, DevOps</p>
            <p className="text-xs text-gray-500 italic">Reality check: Spent more on power than I would've on API calls, but learned tons about LLM deployment!</p>
          </div>
          
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-400">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">🏛️ 3D Cultural Heritage Scanning</h3>
            <p className="text-gray-700 mb-2">
              Photogrammetry project that started as "let's scan this statue" and became a deep dive into Indian history
            </p>
            <p className="text-sm text-gray-600 mb-2">dSLR photography, 3D modeling, cultural preservation</p>
            <p className="text-xs text-gray-500 italic">Plot twist: Getting permission took longer than the actual scanning. Harvard Art Museums are thorough!</p>
          </div>
          
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg border-l-4 border-purple-400">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">🎮 CS Robot Competition</h3>
            <p className="text-gray-700 mb-2">
              2v2 real robot Counter-Strike because regular programming wasn't complicated enough
            </p>
            <p className="text-sm text-gray-600 mb-2">Computer vision, pathfinding algorithms, multi-robot networking</p>
            <p className="text-xs text-gray-500 italic">Current status: Robots can see each other, sometimes they even move. Victory conditions still negotiable.</p>
          </div>
          
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-6 rounded-lg border-l-4 border-yellow-400">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">🤖 Discord Homelab Bot</h3>
            <p className="text-gray-700 mb-2">
              Because manually checking if servers are down is for people without ADHD and coding skills
            </p>
            <p className="text-sm text-gray-600 mb-2">API calls, webhooks, automation scripts</p>
            <p className="text-xs text-gray-500 italic">Works great! Except when I forget to restart it after server updates. Ironic. Working on a script to automate that.</p>
          </div>
        </div>
        
        <h2 className="text-2xl font-bold text-gray-900 mb-4">The Homelab Situation</h2>
        <p className="text-gray-700 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-2">🏠 Main Server</h3>
            <p className="text-sm text-gray-700 mb-1">Games, LLM models, web services, VPN</p>
            <p className="text-xs text-gray-500">Fan noise is the sound of productivity</p>
          </div>
          
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-2">🌐 xhttp VPN</h3>
            <p className="text-sm text-gray-700 mb-1">Deployed on Japanese VPS because reasons</p>
            <p className="text-xs text-gray-500">Docker containers across continents</p>
          </div>
          
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-2">📁 NAS Server</h3>
            <p className="text-sm text-gray-700 mb-1">File hoarding with style</p>
            <p className="text-xs text-gray-500">Automated because manual backups don't happen</p>
          </div>
        </div>
        
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Automation Adventures</h2>
        <ul className="space-y-3 mb-6">
          <li className="bg-blue-50 p-3 rounded-lg">
            <strong className="text-gray-900">Subtitle Automation Pipeline:</strong> 
            <span className="text-gray-700"> LLM-powered video translation that downloads, processes, and translates automatically. </span>
            <span className="text-xs text-gray-500 italic"> Works 80% of the time, breaks spectacularly the other 20%.</span>
          </li>
          <li className="bg-green-50 p-3 rounded-lg">
            <strong className="text-gray-900">3D Printing Automation:</strong> 
            <span className="text-gray-700"> Bambulab A1 mini printer experiments in automated workflows.</span>
            <span className="text-xs text-gray-500 italic"> they already almost perfected it.</span>
          </li>
          <li className="bg-purple-50 p-3 rounded-lg">
            <strong className="text-gray-900">Personal Website:</strong> 
            <span className="text-gray-700"> Building <a href="https://www.harryyu.dev/" className="text-blue-600 hover:text-blue-800">harryyu.dev</a> with React, TypeScript, and Node.js. </span>
            <span className="text-xs text-gray-500 italic">"Learning React and TypeScript, slowly rubbing" - past me was optimistic about timelines.</span>
          </li>
        </ul>
